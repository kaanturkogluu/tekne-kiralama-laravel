...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ url('/admin/users/1') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md font-medium transition duration-150 flex items-center">
        ...
        <form class="p-6 space-y-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" value="Ahmet" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Kullanıcının adı..." required>
                            </div>
                            <div>
                                <label for="last_name" class="block text-sm font-medium text-gray-700 mb-1">Soyad *</label>
                                <input type="text" id="last_name" name="last_name" value="Yılmaz" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Kullanıcının soyadı..." required>
                            </div>
                            <div>
                                <label for="username" class="block text-sm font-medium text-gray-700 mb-1">Kullanıcı Adı *</label>
                                <input type="text" id="username" name="username" value="ahmetyilmaz" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="benzersiz kullanıcı adı..." required>
                            </div>
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-1">E-posta *</label>
                                <input type="email" id="email" name="email" value="ahmet.yilmaz@example.com" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="kullanici@example.com" required>
                            </div>
                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Telefon</label>
                                <input type="tel" id="phone" name="phone" value="+90 555 123 45 67" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="+90 555 123 45 67">
                            </div>
                            <div>
                                <label for="birth_date" class="block text-sm font-medium text-gray-700 mb-1">Doğum Tarihi</label>
                                <input type="date" id="birth_date" name="birth_date" value="1985-01-15" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Şifre Değiştirme -->
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="text-sm font-medium text-gray-900 mb-4">Şifre Değiştirme</h4>
                        <div class="space-y-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="change_password" name="change_password" class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded">
                                <label for="change_password" class="ml-2 block text-sm text-gray-900">
                                    Şifreyi değiştir
                                </label>
                            </div>
                            <div id="password_fields" class="hidden grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="new_password" class="block text-sm font-medium text-gray-700 mb-1">Yeni Şifre</label>
                                    <div class="relative">
                                        <input type="password" id="new_password" name="new_password" class="w-full border border-gray-300 rounded-md px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Yeni şifre...">
                                ...
                                <div>
                                    <label for="new_password_confirmation" class="block text-sm font-medium text-gray-700 mb-1">Yeni Şifre Tekrar</label>
                                    <div class="relative">
                                        <input type="password" id="new_password_confirmation" name="new_password_confirmation" class="w-full border border-gray-300 rounded-md px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Yeni şifreyi tekrar girin...">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Tam adres bilgisi...">Beşiktaş Mahallesi, No:123</textarea>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label for="city" class="block text-sm font-medium text-gray-700 mb-1">Şehir</label>
                                    <input type="text" id="city" name="city" value="İstanbul" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="İstanbul">
                                </div>
                                <div>
                                    <label for="state" class="block text-sm font-medium text-gray-700 mb-1">İl</label>
                                    <input type="text" id="state" name="state" value="İstanbul" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="İstanbul">
                                </div>
                                <div>
                                    <label for="postal_code" class="block text-sm font-medium text-gray-700 mb-1">Posta Kodu</label>
                                    <input type="text" id="postal_code" name="postal_code" value="34000" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="34000">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="bio" name="bio" rows="3" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Kullanıcı hakkında kısa bilgi...">Deniz tutkunu, yatçılık meraklısı</textarea>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="social_media" name="social_media" value="@ahmetyilmaz" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="@kullaniciadi">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            <div class="text-center">
                                <img id="current_photo" class="w-32 h-32 rounded-full mx-auto mb-3 object-cover" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Mevcut Fotoğraf">
                            </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input type="checkbox" id="email_verified" name="email_verified" class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded" checked>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="newsletter" name="newsletter" class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded" checked>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="text-sm font-medium text-gray-900 mb-4">Hesap İstatistikleri</h4>
                        <dl class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                <dt class="text-gray-600">Üyelik Tarihi:</dt>
                                <dd class="text-gray-900">15 Mart 2024</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-gray-600">Son Giriş:</dt>
                                <dd class="text-gray-900">2 saat önce</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-gray-600">Toplam Giriş:</dt>
                                <dd class="text-gray-900">247</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-gray-600">Rezervasyon Sayısı:</dt>
                                <dd class="text-gray-900">12</dd>
                            </div>
                        </dl>
                    </div>
...
<script>
    ...
    // Şifre değiştirme alanlarını göster/gizle
    ...
    function updatePasswordStrengthIndicator(strength) {
        const indicator = document.querySelector('#password_fields .text-xs.text-gray-500');
        if (!indicator) return;
